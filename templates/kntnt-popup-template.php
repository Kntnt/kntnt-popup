<div id="<?= esc_attr( $atts['id'] ) ?>" class="kntnt-popup" aria-hidden="true" style="<?= esc_attr( $atts['style-popup'] ) ?>">
    <div class="kntnt-popup__overlay kntnt-popup--pos-<?= esc_attr( $atts['position'] ) ?>" tabindex="-1" <?= $atts['close_outside_click'] ? ' data-popup-close' : ''; ?> style="<?= esc_attr( $atts['style-overlay'] ) ?>">
